...
function UUF:CreateUnitAlternativePowerBar(unitFrame, unit)
    ...
    AlternativePowerBar.Status:SetPoint("TOPLEFT", AlternativePowerBar, "TOPLEFT", 0, 0)
    AlternativePowerBar.Status:SetPoint("BOTTOMRIGHT", AlternativePowerBar, "BOTTOMRIGHT", 0, 0)
